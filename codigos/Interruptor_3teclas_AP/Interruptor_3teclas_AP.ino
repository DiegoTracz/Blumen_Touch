...
std::map<String, deviceConfig_t> devices = {
   ...
   {"cole aqui o id do device 1"", {5, 16}},
   {"cole aqui o id do device 2"", {4, 14}},
   {"cole aqui o id do device 3"", {2, 12}}  
...
void setupWiFi()
{
  ...
  //wifiManager.resetSettings();
   ...
   wifiManager.autoConnect("AP-INTERRUPTOR", "12345678");
}
...
void loop()
{
  ...
  handleFlipSwitches();
     ...
     Serial.println("resetar"); //tenta abrir o portal
      if(!wifiManager.startConfigPortal("AP-INTERRUPTOR", "12345678") ){
